...
public static class CustomSettings
{
    ...
    {                
        ...
        //custom           
        _GT(typeof (NTGLuaScript)),
        _GT(typeof (NTGLuaScriptExt)),
        _GT(typeof (TGNetService)),
        _GT(typeof (TGNetService.NetRequest)),
        _GT(typeof (TGNetService.NetEvent)),
        _GT(typeof (GameController)),
        _GT(typeof (NTGResourceController)),
        _GT(typeof (NTGResourceController.AssetLoader)),
        _GT(typeof (NTGEventTriggerProxy)),
        

        //battle
        // _GT(typeof (NTGBattleMemberAttrs)),
        // _GT(typeof (NTGBattleUIController.BattleUpdateData)),
        // _GT(typeof (NTGBattleUIController.BattleUpdateSkillData)),
        // _GT(typeof (NTGBattleUIController.BattleUpdatePlayerData)),
        // _GT(typeof (NTGBattleUIController.UIBattleInfoItem)),
        // _GT(typeof (NTGBattleUnitController)),
        // _GT(typeof (NTGBattleUnitController.UnitBuff)),
        // _GT(typeof (NTGBattlePlayerController)),
        //_GT(typeof (NTGBattleMainCameraController)),
        //_GT(typeof (NTGBattleUIController)),
        //_GT(typeof (NTGBattleSkillBehaviour)),   
        ...
        _GT(typeof(WebSocketManager)),
        _GT(typeof(UIComponent)),
        _GT(typeof(UnityEvent)),
        _GT(typeof(UICircularScrollView)),
