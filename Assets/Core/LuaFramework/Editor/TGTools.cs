...
{
    [MenuItem("Tools/TG/Add Mesh Collider")]
    ...
    [MenuItem("Tools/TG/Add Road Tag")]
    ...
    [MenuItem("Tools/TG/Load Role Animation")]
    public static void LoadRoleAnimation()
    {
        foreach (var go in Selection.gameObjects)
        {
            ...
            for (int i = 0; i < clips.Length; i++)
            {
                ...
                mica.maskSource = (UnityEngine.AvatarMask) AssetDatabase.LoadAssetAtPath("Assets/Prefabs/Role/TGRoleAll.mask", typeof (UnityEngine.AvatarMask));
            }
    ...
    [MenuItem("Tools/TG/Load Common Animation")]
    ...
    [MenuItem("Tools/TG/Load UTG Animation")]
