...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(Warfare.WebSocketProxy.BaseWebsocket.OnWebsocketTigger))
			{
			    return new Warfare.WebSocketProxy.BaseWebsocket.OnWebsocketTigger(__Gen_Delegate_Imp0);
			}
			...
			{
			    return new System.Action<UnityEngine.AsyncOperation>(__Gen_Delegate_Imp20);
			}
