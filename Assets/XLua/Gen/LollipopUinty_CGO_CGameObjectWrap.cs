...
namespace XLua.CSObjectWrap
{
    ...
    public class LollipopUintyCGOCGameObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LollipopUinty.CGO.CGameObject);
			Utils.BeginObjectRegister(type, L, translator, 0, 7, 2, 2);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetLoginUrlInfo", _m_GetLoginUrlInfo);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetLoginUrl", _m_SetLoginUrl);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetLoginUrl", _m_GetLoginUrl);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetProxyUrl", _m_SetProxyUrl);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetProxyUrl", _m_GetProxyUrl);
        ...
        static int _m_SetUserInfo(RealStatePtr L)
        {
		    try {
                ...
                {
                    LollipopUnity.GST.UserInfo _userInfo;translator.Get(L, 2, out _userInfo);
                    
                    gen_to_be_invoked.SetUserInfo( _userInfo );
        ...
        static int _m_GetUserInfo(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetUserInfo(  );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetLoginUrl(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetLoginUrl( _url );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetLoginUrl(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetLoginUrl(  );
                        LuaAPI.lua_pushstring(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetProxyUrl(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetProxyUrl(  );
                        LuaAPI.lua_pushstring(L, gen_ret);
        ...
        static int _g_get_OpenId(RealStatePtr L)
        {
		    try {
                ...
                LollipopUinty.CGO.CGameObject gen_to_be_invoked = (LollipopUinty.CGO.CGameObject)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.OpenId);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
